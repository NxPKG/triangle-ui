...
# triangle-ui
$(eval $(call DOCKER_IMAGE_TEMPLATE,triangle-ui,.,Dockerfile,triangle-ui,$(DOCKER_IMAGE_TAG)))

# triangle-ui-backend
$(eval $(call DOCKER_IMAGE_TEMPLATE,triangle-ui-backend,backend,backend/Dockerfile,triangle-ui-backend,$(DOCKER_IMAGE_TAG)))