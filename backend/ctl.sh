...
function build_proto_inner() {
    ...
    GO_MAPPINGS+=",Mui/ui.proto=github.com/khulnasoft/triangle-ui/backend/proto/ui"
    GO_MAPPINGS+=",Mui/notifications.proto=github.com/khulnasoft/triangle-ui/backend/proto/ui"
    GO_MAPPINGS+=",Mui/status.proto=github.com/khulnasoft/triangle-ui/backend/proto/ui"
